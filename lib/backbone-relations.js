...
(function(root, factory) {
  if ((typeof define !== "undefined" && define !== null ? define.amd : void 0)) {
    ...
    return factory(exports, require('vendor/backbone'), require('vendor/underscore'));
  } else {
  ...
  RelationalModel = (function(_super) {
    ...
    RelationalModel.one = function(name, model, options) {
      ...
      this.prototype.mutators[name] = function() {
        var definition, link, _ref, _ref1;
        if (this["_" + name]) {
          return this["_" + name];
        }
        definition = this.constructor._associations[name];
        switch (false) {
          ...
          case !definition.through:
            if (this.constructor._associations[definition.through].plural) {
              ...
              this["_" + name] = this.get(definition.through).get((_ref = definition.source) != null ? _ref : name);
              if (definition.links && (link = (_ref1 = this.get('links')) != null ? _ref1[name] : void 0)) {
                this["_" + name] = this["_" + name].get(link);
              }
            }
            break;
          default:
