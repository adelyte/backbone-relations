  ...
  RelationalModel = (function(_super) {
    ...
    RelationalModel.many = function(name, model, options) {
      ...
      this.prototype.mutators[name] = function() {
        var Collection, data, definition, inverse;
        if (this["_" + name]) {
          return this["_" + name];
        }
        ...
        data = (function() {
          ...
          switch (false) {
            case !definition.embeds:
              return (_ref = this.get('linked')) != null ? _ref[name] : void 0;
            default:
